...
class Conectividade(threading.Thread):
    ...
    def run(self):
        t_solicitar_conexao = threading.Thread(target=self.solicitar_conexao, args=('127.0.0.1', 55431))
        t_aguardar_conexao = threading.Thread(target=self.aguardar_conexao, args=('127.0.0.1', 45551))
...
if __name__ == '__main__':
    connect = Conectividade('127.0.0.1', 45551)
    connect.run()
